...
$moduledir = 'legalnotice';
$myTmpObjects = array();
//$myTmpObjects['legalnotice'] = array('includerefgeneration'=>1, 'includedocgeneration'=>0);
					...
					while (($file = readdir($handle)) !== false)
					{
						if (strpos($file, 'mod_'.strtolower($myTmpObjectKey).'_') === 0 && substr($file, dol_strlen($file) - 3, 3) == 'php')
						{
							...
							if ($module->isEnabled())
							{
								...
								$constforvar = 'LEGALNOTICE_'.strtoupper($myTmpObjectKey).'_ADDON';
