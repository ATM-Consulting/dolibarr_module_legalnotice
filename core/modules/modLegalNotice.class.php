...
class modLegalNotice extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//							'css' => array('/legalnotice/css/legalnotice.css.php'),	// Set this to relative path of css file if module has its own css file
...
*/
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=legalnotice',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'LegalNotice top menu',
		//							'mainmenu'=>'legalnotice',
		//							'leftmenu'=>'legalnotice_left',			// This is the name of left menu for the next entries
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=legalnotice,fk_leftmenu=legalnotice_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'LegalNotice left menu',
		//							'mainmenu'=>'legalnotice',
		//							'leftmenu'=>'legalnotice_left',			// Goes into left menu previously created by the mainmenu
...
/*
		$this->menu[$r]=array(
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuLegalNotice'),
			'mainmenu'=>'legalnotice',
			'leftmenu'=>'',
			'url'=>'/legalnotice/list.php',
			'langs'=>'legalnotice@legalnotice',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>"isModEnabled('legalnotice')",	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=legalnotice',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuLegalNotice'),
			'mainmenu'=>'legalnotice',
			'leftmenu'=>'legalnotice_left',
			'url'=>'/legalnotice/list.php',
			'langs'=>'legalnotice@legalnotice',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>"isModEnabled('legalnotice')",	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=legalnotice,fk_leftmenu=legalnotice_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuLegalNoticeCreate'),
			'mainmenu'=>'legalnotice',
			'leftmenu'=>'legalnotice_left_create',
			'url'=>'/legalnotice/card.php?action=create',
			'langs'=>'legalnotice@legalnotice',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> "isModEnabled('legalnotice')",  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=legalnotice,fk_leftmenu=legalnotice_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuLegalNoticeList'),
			'mainmenu'=>'legalnotice',
			'leftmenu'=>'legalnotice_left_list',
			'url'=>'/legalnotice/list.php',
			'langs'=>'legalnotice@legalnotice',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> "isModEnabled('legalnotice')",  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
