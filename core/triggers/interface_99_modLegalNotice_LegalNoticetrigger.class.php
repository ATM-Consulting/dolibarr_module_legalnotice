...
/**
 * 	\file		core/triggers/interface_99_modMyodule_LegalNoticetrigger.class.php
 * 	\ingroup	legalnotice
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modLegalnotice_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceLegalNoticetrigger
{
