 ...
 */
class legalnoticebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "legalnotice@legalnotice";
    public $boxlabel;
    public $depends = array("legalnotice");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/legalnotice/class/legalnotice.class.php";
